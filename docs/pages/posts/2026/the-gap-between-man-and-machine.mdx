...
And I take some of pride in the development process. Research and design, on the other hand, requires a bit of detatchment from beginning with solution solutions and instead having a focus on the user and their problems.
