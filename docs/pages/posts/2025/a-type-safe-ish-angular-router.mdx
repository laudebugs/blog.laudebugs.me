...
# Type-Safe-ish Angular Router
![Cover Photo](/assets/post-covers/a-type-safe-ish-angular-router.jpg)

> Attempting to typing the Angular Router navigation functions (`Router.navigate`; `Router.navigateByUrl`).
